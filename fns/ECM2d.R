#' ###############
#' Function file for ECM
#' on a (2D) random effects structure (intercept + slope)
#' ###############
...
# Define EM function ------------------------------------------------------
em <- function(data,
               init.beta, init.var.0, init.D = NULL,
  ...
  # Initial D matrix
  if(is.null(init.D)) D <- diag(2) else D <- init.D
